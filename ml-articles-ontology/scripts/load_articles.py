...
# This script loads ML articles from a CSV file, converts them to RDF triples in Turtle format,
# and uploads them to a GraphDB instance.
...
df = pd.read_csv("data/ml_articles_dataset.csv")
...
with open("ttl_files/out.ttl", "w", encoding="utf-8") as f:
    f.write(ttl)
print("Wrote out.ttl")
